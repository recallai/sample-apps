...
import { bot_separate_audio_streams_event_handler, close_audio_streams_event_handler } from "./bot_separate_audio_streams_event_handler";
...
wss.on("connection", (socket: WebSocket & { recording_id: string }) => {
    ...
    socket.on("message", (raw_msg) => {
        ...
        bot_separate_audio_streams_event_handler({ msg });
    });
