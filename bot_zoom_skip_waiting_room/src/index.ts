...
After you complete the OAuth flow, you can then create a bot.
  - Ensure that \`zoom.join_token_url="https://${process.env.NGROK_DOMAIN ?? "NGROK_DOMAIN"}/zoom/join-token"\` is set in the bot's configuration.
  - Ensure that \`zoom.obf_token_url="https://${process.env.NGROK_DOMAIN ?? "NGROK_DOMAIN"}/zoom/obf-token"\` is set in the bot's configuration.
