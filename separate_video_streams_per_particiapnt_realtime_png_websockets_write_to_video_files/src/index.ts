...
import { separate_png_video_streams_event_handler, close_png_video_streams_event_handler } from "./separate_png_video_streams_event_handler";
...
wss.on("connection", (socket: WebSocket & { recording_id: string }) => {
    ...
    socket.on("message", (raw_msg) => {
        ...
        separate_png_video_streams_event_handler({ msg });
    });
